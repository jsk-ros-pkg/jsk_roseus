...
macro(genmsg_eus)
  ...
  # files
  message("[roseus.cmake] add custom target ROSBUILD_roseus_genmsg_${PROJECT_NAME}")
...
macro(gensrv_eus)
  ...
  # Create a target that depends on the union of all the autogenerated
  # files
  message("[roseus.cmake] add custom target ROSBUILD_roseus_gensrv_${PROJECT_NAME}")
